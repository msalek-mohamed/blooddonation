...
<body class="theme-red">
	<%@include file="../Contents/contentMessage.jsp" %> 
</body>
 ...
 <!-- Jquery Core Js -->
    ...
    <script src="./Ressources/plugins/ckeditor/ckeditor.js"></script>
    <script src="./Ressources/Js/ApplicationWeb/pages/forms/editors.js"></script>   
